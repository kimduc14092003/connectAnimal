...
public class Tutorial3 : MonoBehaviour
{
    ...
    public GameObject tempWall,tempWall2;
    public GameObject clickEffect, bubuEffect1, bubuEffect2;
    ...
    IEnumerator SelectedCell(GameObject cell)
    {
        ...
        clickEffect.transform.position = cell.transform.position;
    ...
    IEnumerator CreateLine(GameObject g1, GameObject g2)
    {
        ...
        lineController.CreateLine(g1, tempWall,tempWall2, g2);
    ...
    {
        tutorialController.OpenPanelTutorialDone();
        Destroy(gameObject);
    }
